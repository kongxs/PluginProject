...
public class Camera1HelperTexture {
    ...
    public Camera1HelperTexture(Context mContext) {
    ...
    public void open(SurfaceTexture texture , boolean isFront) {

        this.mHolder = texture;
...
//            camera.setPreviewDisplay(holder);
    ...
    public void stopRecorder(){
        if (isRecorder){ //如果在录制视频
            ...
            isRecorder = false;
            try {
                camera.setPreviewTexture(mHolder);//重新设置预览SurfaceTexture
    ...
    private void configMedioRecorder(){
        ...
        Surface surface = new Surface(mHolder);
